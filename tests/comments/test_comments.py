...
def test_line_at_eof():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/comments/line_at_eof.lox'  # noqa: E501
...
def test_only_line_comment_and_line():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/comments/only_line_comment_and_line.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_only_line_comment():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/comments/only_line_comment.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_unicode():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/comments/unicode.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
