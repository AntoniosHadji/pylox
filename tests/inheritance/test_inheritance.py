...
def test_parenthesized_superclass():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/inheritance/parenthesized_superclass.lox'  # noqa: E501
...
def test_inherit_from_nil():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/inheritance/inherit_from_nil.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_inherit_methods():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/inheritance/inherit_methods.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_set_fields_from_base_class():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/inheritance/set_fields_from_base_class.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_constructor():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/inheritance/constructor.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_inherit_from_function():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/inheritance/inherit_from_function.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_inherit_from_number():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/inheritance/inherit_from_number.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
