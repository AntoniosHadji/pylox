...
def test_error_after_multiline():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/string/error_after_multiline.lox'  # noqa: E501
...
def test_literals():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/string/literals.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_unterminated():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/string/unterminated.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_multiline():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/string/multiline.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
