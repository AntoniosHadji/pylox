...
def test_literals():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/number/literals.lox'  # noqa: E501
...
def test_decimal_point_at_eof():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/number/decimal_point_at_eof.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_nan_equality():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/number/nan_equality.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_leading_dot():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/number/leading_dot.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_trailing_dot():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/number/trailing_dot.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
