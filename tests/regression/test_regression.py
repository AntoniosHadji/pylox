...
def test_394():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/regression/394.lox'  # noqa: E501
...
def test_40():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/regression/40.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
