...
def test_empty():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/block/empty.lox'  # noqa: E501
...
def test_scope():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/block/scope.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
