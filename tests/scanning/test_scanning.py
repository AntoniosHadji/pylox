...
def test_strings():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/scanning/strings.lox'  # noqa: E501
...
def test_identifiers():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/scanning/identifiers.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_punctuators():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/scanning/punctuators.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_keywords():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/scanning/keywords.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_whitespace():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/scanning/whitespace.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_numbers():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/scanning/numbers.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
