...
def test_too_many_locals():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/limit/too_many_locals.lox'  # noqa: E501
...
def test_too_many_upvalues():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/limit/too_many_upvalues.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_too_many_constants():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/limit/too_many_constants.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_stack_overflow():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/limit/stack_overflow.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode


def test_no_reuse_constants():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/limit/no_reuse_constants.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode


def test_loop_too_large():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/limit/loop_too_large.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
