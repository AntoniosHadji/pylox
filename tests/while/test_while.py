...
def test_class_in_body():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/while/class_in_body.lox'  # noqa: E501
...
def test_closure_in_body():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/while/closure_in_body.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_return_inside():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/while/return_inside.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_fun_in_body():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/while/fun_in_body.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_syntax():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/while/syntax.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_return_closure():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/while/return_closure.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_var_in_body():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/while/var_in_body.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
