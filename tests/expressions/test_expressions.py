...
def test_parse():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/expressions/parse.lox'  # noqa: E501
...
def test_evaluate():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/expressions/evaluate.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
