...
def test_closure():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/this/closure.lox'  # noqa: E501
...
def test_nested_closure():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/this/nested_closure.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_nested_class():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/this/nested_class.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_this_at_top_level():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/this/this_at_top_level.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_this_in_method():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/this/this_in_method.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_this_in_top_level_function():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/this/this_in_top_level_function.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
