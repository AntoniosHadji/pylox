...
def test_object():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/call/object.lox'  # noqa: E501
...
def test_bool():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/call/bool.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_nil():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/call/nil.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_string():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/call/string.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
...
def test_num():
    test_file = '/mnt/projects/csdiy/compilers-8/bradfield/loxPy/tests/call/num.lox'  # noqa: E501
    resultp = subprocess.run(['python3', 'lox.py', test_file], capture_output=True)
    resultj = subprocess.run(['../craftinginterpreters/jlox', test_file], capture_output=True)
    assert resultp.returncode == resultj.returncode
